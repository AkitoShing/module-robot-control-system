...
/* *** EVT SERIAL LISTENER *** */
EvtSerialListener::EvtSerialListener() {}

EvtSerialListener::EvtSerialListener(SoftwareSerial serial, int baudrate) {
    this->serial = serial;
...
bool EvtSerialListener::performTriggerAction(EvtContext *c) {
  return false;
}